...
typedef void (*UG_Message_Callback)( UG_MESSAGE* );
struct S_WINDOW
{
   UG_U8 objcnt;
   UG_OBJECT* objlst;
...
#define WND_STATE_TITLE_PRESSED                       (1<<7)
/* Window styles */
...
typedef void (*UG_GUI_PSET)(UG_S16,UG_S16,UG_COLOR);
typedef struct
{
   UG_GUI_PSET pset;
   UG_S16 x_dim;
...
/* -------------------------------------------------------------------------------- */
/* Classic functions */
typedef void (*UG_Init_Callback)(UG_S16,UG_S16,UG_COLOR);

UG_S16 UG_Init( UG_GUI* g, UG_Init_Callback p, UG_S16 x, UG_S16 y );
UG_S16 UG_SelectGUI( UG_GUI* g );
UG_FONT* UG_GetFont(FONT_ID font_id);
void UG_FontIdSelect( FONT_ID font_id );
...
/* Window functions */
typedef void (*UG_Message_Callback)( UG_MESSAGE* );
UG_RESULT UG_WindowCreate( UG_WINDOW* wnd, UG_OBJECT* objlst, UG_U8 objcnt, UG_Message_Callback cb );
...
UG_RESULT UG_WindowSetTitleTextFont( UG_WINDOW* wnd, FONT_ID font_id );
...
UG_RESULT UG_ButtonSetFont( UG_WINDOW* wnd, UG_U8 id, FONT_ID font_id );
...
UG_RESULT UG_CheckboxSetFont( UG_WINDOW* wnd, UG_U8 id, FONT_ID font_id);
...
UG_RESULT UG_TextboxSetFont( UG_WINDOW* wnd, UG_U8 id, FONT_ID font_id );
